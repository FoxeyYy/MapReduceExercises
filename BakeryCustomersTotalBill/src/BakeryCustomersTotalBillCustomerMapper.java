...
public class BakeryCustomersTotalBillCustomerMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		while (linesItr.hasMoreTokens()) {
			...
			context.write(new IntWritable(Integer.valueOf(line[0])), new Text("A," + line[2] + "," + line[1]));
		}
