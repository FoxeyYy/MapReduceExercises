...
public class BakeryCustomersTotalBillReceiptMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		while (linesItr.hasMoreTokens()) {
			...
			context.write(new IntWritable(Integer.valueOf(line[0])), new Text("B," + line[2]));
		}
